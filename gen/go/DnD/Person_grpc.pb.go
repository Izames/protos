...
type PersonServiceClient interface {
	CreatePerson(ctx context.Context, in *CPRequest, opts ...grpc.CallOption) (*CPResponse, error)
}
...
func (c *personServiceClient) CreatePerson(ctx context.Context, in *CPRequest, opts ...grpc.CallOption) (*CPResponse, error) {
...
type PersonServiceServer interface {
	CreatePerson(context.Context, *CPRequest) (*CPResponse, error)
...
func (UnimplementedPersonServiceServer) CreatePerson(context.Context, *CPRequest) (*CPResponse, error) {
...
func _PersonService_CreatePerson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).CreatePerson(ctx, req.(*CPRequest))
	}
